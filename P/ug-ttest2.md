...
and additionally using the [invariance of the variance under addition](/P/var-inv) and applying the null hypothesis from \eqref{eq:t-h0}, the distribution of $Z = [(\bar{y}_1-\bar{y}_2)-\mu_\Delta]/[\sigma \cdot \sqrt{\frac{1}{n_1}+\frac{1}{n_2}}]$ becomes [standard normal](/D/snorm)
