...
$$ \label{eq:gam-mgf}
M_X(t) = \left( 1-\frac{t}{\beta} \right)^{-\alpha}, \; t < \beta, \; \beta > 0 \; .
$$
...
If there is a [random variable](/D/rvar) $X \sim \mathrm{Gam}\left( \frac{n}{2}, \frac{1}{2} \right)$, then

$$ \label{eq:gam-chi2-mgf}
M_X(t) = \left( 1-\frac{t}{\frac{1}{2}} \right)^{-(n/2)} = (1-2t)^{-n/2} = M_Y(t)
\quad \text{for} \quad
t < \frac{1}{2}
$$
