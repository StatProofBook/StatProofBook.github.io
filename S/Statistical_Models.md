...
| Model | Definition | Estimation | Maximum<br>likelihood<br>estimation | Conjugate prior<br>distribution | Posterior<br>distribution | Log model<br>evidence | Other |
|:----- |:---------- |:---------- |:----------------------------------- |:------------------------------- |:------------------------- |:--------------------- |:----- |
...
| Poisson distribution<br>with exposure values | *[poissexp](/D/poissexp)* |  |  | **[poissexp-prior](/P/poissexp-prior)** | **[poissexp-post](/P/poissexp-post)** | **[poissexp-lme](/P/poissexp-lme)** |  |
| **Probability data** |  |  |  |  |  |  |  |
